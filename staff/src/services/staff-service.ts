...
import HeadTeacher from "../database/models/headteacher";
...
import BcryptPassword from "../utils/utils.bcrypt.password";
import registrationUtils from "../utils/utils.registration";
...
class StaffController implements StaffInterface {
  bcryptPassword: BcryptPassword;
  registrationUtils: registrationUtils;
  constructor() {
  ...
  register = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      const verifyEmail = await PreRegistrationModel.findOne({
  ...
  registerHeadTeacher = async (
    ...
    try {
      ...
      const newHeadTeacher = await HeadTeacher.create({
        ...userData,
        password: hashedPassword,
      });
  ...
  addStaffToClass = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
